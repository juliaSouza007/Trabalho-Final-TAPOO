...
const DIALOGO = [
	{"personagem": "Protagonista", "fala": "Eu lembro agora… tudo o que vivi, e tudo o que deixei passar."},
	{"personagem": "Coelho do Tempo", "fala": "Você não perdeu tempo. Ele apenas te esperou."},
	{"personagem": "Coelho do Tempo", "fala": "O tempo não é inimigo — é espelho. Ele mostra o que você faz com ele."},
	{"personagem": "Protagonista", "fala": "E se eu quiser recomeçar?"},
	{"personagem": "Coelho do Tempo", "fala": "Então acorde."},
]

var indice_atual = 0
const PROXIMA_CENA = "res://scenes/hospital_scene.tscn" 
