...
const DIALOGO = [
	{"personagem": "Protagonista", "fala": "Esse lugar… é meu quarto? Mas tudo parece menor."},
	{"personagem": "Coelho do Tempo", "fala": "Sim. O tempo encolhe as lembranças até que pareçam brinquedos esquecidos."},
	{"personagem": "Coelho do Tempo", "fala": "Procure o que deixou para trás. Cada objeto aqui é um fio da sua história."},
	{"personagem": "Protagonista", "fala": "Por que preciso ver tudo isso?"},
	{"personagem": "Coelho do Tempo", "fala": "Porque o tempo não cura o que você não entende. O que foi deixado aqui… ainda te espera."},
]

var indice_atual = 0
const PROXIMA_CENA = "res://scenes/quarto_scene.tscn" 
